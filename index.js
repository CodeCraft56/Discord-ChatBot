...
setInterval(async () => {
const statuses = [`CodeCraft`, `?help`]
   client.user.setActivity(statuses[Math.floor(Math.random() * statuses.length)], { type: "WATCHING", url: "https://discord.gg/UjtrDXwRKx"})
}, 10000)
});
...
client.on("message", async message => {
  if (message.channel.type === "dm") {
    ...
    const chat = new Chat({ name: "CodeCraft", gender: "male", developer_name: "CodeCraft", user: "1095706937926103160", language: "en" }); //Put your id here
